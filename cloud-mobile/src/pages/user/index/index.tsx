                    ...
                    <Card>
                        <Row justify={"space-around"}>
                            <Col onClick={()=>historyPush('user.list')}>
                                <div className={nav}><Icon type={Tabulate} style={{display:"block",fontSize:"22px",lineHeight:1.3}}/>代练列表</div>
                            </Col>
                            <Col onClick={()=>historyPush('user.pay')}>
                                <div className={nav}><Icon type={Recharge} style={{display:"block",fontSize:"22px",lineHeight:1.3}}/>余额充值</div>
                            </Col>
                            <Col onClick={()=>historyPush('user.help')}>
                                <div className={nav}><Icon type={Help} style={{display:"block",fontSize:"22px",lineHeight:1.3}}/>使用帮助</div>
                            </Col>
                            <Col onClick={()=>historyPush('user.person')}>
                                <div className={nav}><Icon type={User} style={{display:"block",fontSize:"22px",lineHeight:1.3}}/>我的账户</div>
                            </Col>
                        </Row>
                    </Card>
                </Grid.Item>
