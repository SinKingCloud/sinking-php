...
import {updateUserInfo, updateUserMoney} from "@/services/master/user";
...
import {createDomain, deleteDomain, getWebList, updateDomain, updateWebInfo} from "@/services/master/web";
import moment from "moment";
import {getDomainList} from "@/services/admin/web";
    ...
    },
    {
      ...
      render: (text: string, record: any) => {
        return <Dropdown overlay={<Menu>
          ...
          <Menu.Item key={"status"} hidden={record?.id == currentUser?.web_id}>
            <a style={{fontSize: "small"}} onClick={() => {
          ...
          <Menu.Item key={"status_site"} hidden={record?.id == currentUser?.web_id}>
            <a style={{fontSize: "small"}} onClick={() => {
