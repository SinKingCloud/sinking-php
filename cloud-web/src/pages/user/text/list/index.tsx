...
export default () => {
    ...
    const {styles:{card,li}} = useStyles()
    ...
    return (
        <Body breadCrumb={false}>
            <Row style={{display:"flex",justifyContent:"space-around"}}>
                <Col span={10} style={{padding:"15px",backgroundColor:theme.isDarkMode? "rgb(20,20,20)" : "#fff",borderRadius:"5px"}}>
                ...
                <Col span={13} style={{padding:"15px",backgroundColor:theme.isDarkMode? "rgb(20,20,20)" : "#fff",borderRadius:"5px"}}>
                    <List
            ...
            <Drawer title={<Title>文章详情</Title>} placement="bottom" forceRender={true} height="100%" onClose={()=>setOpen(false)} open={open}>
                <p>Some contents...</p>
                <p>Some contents...</p>
                <p>Some contents...</p>
            </Drawer>
