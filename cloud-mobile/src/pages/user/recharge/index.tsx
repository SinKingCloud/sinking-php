        ...
        <Body showHeader={false} bodyStyle={{padding:0}}>
            <Grid columns={1} gap={8}>
                ...
                <Grid.Item>
                    <Card className={card} >
                        <List className={list} style={{borderRadius:"5px"}}>
                            <List.Item className={item} prefix={<Icon style={{fontSize:"22px",color:"blue"}} type={Money}/>} onClick={() =>historyPush("pay.recharge")}>
                                充值金额
                            </List.Item>
                            <List.Item className={item} prefix={<Icon style={{fontSize:"22px",color:"#ff8f1f"}} type={Type}/>} onClick={() =>historyPush("pay.station")}>
                                开通主站
                            </List.Item>
                        </List>
                    </Card>
                ...
                <Grid.Item>
                    <Card className={card} >
                        <List className={list} >
                            <List.Item className={item} prefix={<Icon style={{fontSize:"22px",color:"#05d005"}} type={Text1}/>} onClick={() => historyPush("pay.record")}>
                                订单记录
                            </List.Item>
                            <List.Item className={item} prefix={<Icon style={{fontSize:"22px",color:"#05d005"}} type={Text1}/>} onClick={() =>historyPush("pay.balance")}>
                                余额明细
                            </List.Item>
                        </List>
                    </Card>
