...
class Curl
{
     ...
     * @return array|string
     */
    public static function get($url, $params = '', $header = array(), $timeout = 30, $options = array())
    {
     ...
     * @return array|string
     */
    public static function post($url, $params = '', $header = array(), $timeout = 30, $options = array())
    {
     ...
     * @return array|string
     */
    public static function delete($url, $params = '', $header = array(), $timeout = 30, $options = array())
    {
     ...
     * @return array|string
     */
    public static function put($url, $params = '', $header = array(), $timeout = 30, $options = array())
    {
     ...
     * @return array|string
     */
    private static function send($url, $params = '', $method = 'GET', $header = array(), $timeout = 30, $options = array())
    {
        ...
        $opt[CURLOPT_HTTPHEADER] = $header ?: array('Expect:');
        ...
        switch (strtoupper($method)) {
            ...
            default:
                return array('error' => 0, 'msg' => '请求的方法不存在', 'info' => array());
                break;
        }
        ...
        if ($result == false || !empty($error)) {
            ...
            curl_close($ch);
            return array('error' => $errno, 'msg' => $error, 'info' => $info);
        }
        curl_close($ch);
        return $result;
    }
