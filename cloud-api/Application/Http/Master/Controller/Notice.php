...
class Notice extends Common
{
    ...
    public function lists()
    {
        ...
        $data = $this->validate(array(
            ...
            array('web_id|站点ID', 'omitempty|number|default:0'),
    ...
    public function create()
    {
        ...
        if (NoticeService::getInstance()->create($data)) {
            LogService::getInstance()->add(Log::TYPE_LOOK, '查看公告', '查看公告列表');
    ...
    public function update()
    {
        ...
        if (NoticeService::getInstance()->update($where, $data)) {
            LogService::getInstance()->add(Log::TYPE_UPDATE, '修改公告', '修改公告信息');
    ...
    public function delete()
    {
        ...
        if (NoticeService::getInstance()->delete(array(
            ...
            LogService::getInstance()->add(Log::TYPE_DELETE, '删除公告', '删除公告数据');
