...
class Cache
{
    const DEFAULT_TIME = 600; //默认缓存时间

    const SYSTEM_CONFIG_NAME = 'system_config'; //系统配置缓存标识名称
    const SYSTEM_CONFIG_TIME = self::DEFAULT_TIME; //系统配置缓存时间(秒)

    const SYSTEM_SETTING_NAME = 'system_setting'; //其他配置缓存标识名称
    const SYSTEM_SETTING_TIME = self::DEFAULT_TIME; //其他配置缓存时间(秒)

    const USER_INFO_NAME = 'user_info'; //用户信息缓存标识名称
    const USER_INFO_TIME = self::DEFAULT_TIME; //用户信息缓存时间(秒)

    const WEB_INFO_NAME = 'web_info'; //站点信息缓存标识名称
    const WEB_INFO_TIME = self::DEFAULT_TIME; //站点信息缓存时间(秒)

    const DOMAIN_INFO_NAME = 'domain_info'; //域名信息缓存标识名称
    const DOMAIN_INFO_TIME = self::DEFAULT_TIME; //域名信息缓存时间(秒)
