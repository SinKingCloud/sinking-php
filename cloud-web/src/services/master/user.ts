...
/** 用户列表 GET /master/user/lists */
export async function getUserList(params?: {}, options?: { [key: string]: any }) {
  return request<API.Response>('/master/user/lists', {
    method: 'GET',
    params: {
      ...params,
    },
...
export async function updateUserInfo(body: any, options?: { [key: string]: any }) {
  return request<API.Response>('/master/user/update', {
    method: 'POST',
    headers: {
...
export async function updateUserMoney(body: any, options?: { [key: string]: any }) {
  return request<API.Response>('/master/user/money', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
