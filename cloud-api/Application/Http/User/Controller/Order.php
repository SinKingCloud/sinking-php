...
class Order extends Common
{
    ...
    public function lists()
    {
        ...
        $data = $this->validate(array(
            ...
            array('trade_no|订单号', 'omitempty|number'),
            array('out_trade_no|内部订单号', 'omitempty|number'),
            ...
            array('order_by_field|排序字段', 'omitempty|default:id|in:id,pay_type,order_type,status,create_time'),
        ...
        return $this->success('获取成功', OrderService::getInstance()->page($data, $data['order_by_field'], $data['order_by_type'], $page, $page_size));
    }
}
